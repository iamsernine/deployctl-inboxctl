...
# Study: https://www.gnu.org/software/bash/manual/html_node/Bash-Builtins.html#index-command (command -v)
# -----------------------------------------------------------------------------
deployctl_check_dependencies() {
    local missing=()
...
# Returns: 0
# Study: https://www.gnu.org/software/bash/manual/html_node/Directory-Operations.html (mkdir -p)
# -----------------------------------------------------------------------------
deployctl_ensure_layout() {
...
# Study: ss(8) / iproute2 — inspect listening sockets from scripts
# -----------------------------------------------------------------------------
deployctl_check_port_free() {
    local port="$1"
